...
export default {
    ...
    effects: {
        ...
        * settingInfo({ payload, callback }, { call, put }) {
            const response = yield call(wechat.settingInfo, payload);
            yield put({
                type: "_settingInfo",
                payload: response
            });
        ...
        * settingEdit({ payload, callback }, { call, put }) {
            const response = yield call(wechat.settingEdit, payload);
            yield put({
                type: "_settingEdit",
                payload: response
            });
        ...
        * miniTemplateEdit({ payload, callback }, { call, put }) {
            const response = yield call(wechat.miniTemplateEdit, payload);
            yield put({
                type: "_miniTemplateEdit",
                payload: response
            });
            if (callback) callback(response);
        },
        * miniTemplateInfo({ payload, callback }, { call, put }) {
            const response = yield call(wechat.miniTemplateInfo, payload);
            yield put({
                type: "_miniTemplateInfo",
                payload: response
            });
            if (callback) callback(response);
        }
    ...
    reducers: {
        ...
        _miniTemplateEdit(state, action) {
            return {
                ...state,
                miniTemplateEdit: action.payload
            };
        },
        _miniTemplateInfo(state, action) {
            return {
                ...state,
                miniTemplateInfo: action.payload
            };
        }
    }
};
