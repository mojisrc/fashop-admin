export default {
  ...
  effects: {
    ...
    * settingSmspro({ payload }, { call, put }) {
      return dispatch => {
        dispatch({
    ...
    * smsScenceedit({ payload }, { call, put }) {
      return dispatch => {
        dispatch({
...
// todo  是啥
    ...
    * setSmsProvide({ payload }, { call, put }) {
...
// todo 这是啥
    * sendSmsScence({ payload }, { call, put }) {
    ...
    * sendSmsScenceInfo({ payload }, { call, put }) {
