...
export default {
    ...
    async settingEdit(data = {}) {
        return fa.request({
            url: `/admin/wechat/settingEdit`,
            method: "POST",
            data
        });
    },
    async miniTemplateEdit(data = {}) {
        return fa.request({
            url: `/admin/wechat/miniTemplateEdit`,
            method: "POST",
            data
        });
    },
    async miniTemplateInfo(data = {}) {
        return fa.request({
            url: `/admin/wechat/miniTemplateInfo`,
            method: "GET",
            data
        });
    },
