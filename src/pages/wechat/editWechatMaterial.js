...
type Props = {
    ...
    editWechatMaterial:Function,
    getWechatMaterialInfo:Function,
    getWechatMaterialInfo:Function,
}
type State = {
    media:Array<{
...
export default class EditWechatMaterial extends Component<Props,State> {
    state = {
        media:[],
        active:0,
    }
...
class CardContent extends Component<
    ...
    render(){
        const { media, active, pathSearch, changeMedia, editWechatMaterial } = this.props
