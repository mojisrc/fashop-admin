...
import { getFreightInfo } from "../../actions/deliver/freight";
...
@Form.create()
export default class FreightEdit extends Component<Props, State> {
    state = {
        info: {
            id: 0,
            name: '',
    ...
    async componentDidMount() {
        ...
        const e = await getFreightInfo({ params: { id } })
        if (e.code === 0) {
            const { info } = e.result
            this.setState({
                info,
