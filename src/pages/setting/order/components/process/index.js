...
import { Alert,  InputNumber, Row, Col, Button, message } from "antd";
...
export default class OrderProcess extends Component {
    ...
    async componentDidMount() {
        ...
        dispatch({
            type: "order/settingInfo",
            callback: (e) => {
                if (e.code === 0) {
                    const { order_auto_close_expires, order_auto_confirm_expires, order_auto_close_refound_expires } = e.result.info;
                    this.setState({
