...
export default class FreightListTable extends Component  <Props, State> {
    state = {
        page: 1,
        rows: 10,
        areaList: []
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (record) => <View className={styles.operation}>
                    <a
                        onClick={() => {
                            this.props.history.push(`/setting/deliver/freightEdit?id=${record.id}`)
                        }}
                    >
                        编辑
                    </a>
            ...
            <View>
                <View className={styles.batchView}>
                    <Button
                        type='primary'
                        onClick={() => {
                            history.push('/setting/deliver/freightAdd')
                        }}
                    >
                        新增运费模板
                    </Button>
